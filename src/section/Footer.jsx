 ...
 */
const socials = [
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/kousik-maity-b82a10285" },
    ...
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        ...
        <div className="w-full flex items-center justify-center gap-4">
          <img src={downloadLogo} alt="K Logo" className="w-20 h-20 md:w-28 md:h-28" />
          <h1
        ...
        <p className="text-xs text-gray-400">
          © {new Date().getFullYear()} Kousik Maity. All rights reserved.
        </p>
      </motion.div>
    </footer>
  );
